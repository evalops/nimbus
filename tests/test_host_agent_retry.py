...
from smith.host_agent.agent import HostAgent
...
async def test_host_agent_lease_retries(monkeypatch, tmp_path):
    ...
    monkeypatch.setenv("SMITH_AGENT_LEASE_RETRIES", "3")
    monkeypatch.setenv("SMITH_AGENT_LEASE_RETRY_BASE", "0.01")
    monkeypatch.setenv("SMITH_AGENT_LEASE_RETRY_MAX", "0.02")
    ...
    monkeypatch.setattr("smith.host_agent.agent.asyncio.sleep", fake_sleep)
